...
from MeguBot import FROG_USERS, WHITELIST_USERS, dispatcher
...
def check_flood(update, context) -> str:
    ...
    try:
        ...
        return "<b>{}:</b>" \
               "\n#{}" \
               "\n<b>Usuario:</b> {}" \
               "\nFloodeó en el grupo.".format(html.escape(chat.title), tag,
        ...
        return "<b>{}:</b>" \
               "\n#Info" \
               "\nNo tengo suficientes permisos para restringir a los usuarios, por lo que la función anti-flood se desactiva automáticamente".format(chat.title)
...
__help__ = """
El antiflood le permite tomar medidas sobre los usuarios que envían más de x mensajes seguidos. Superando el flood establecido \
