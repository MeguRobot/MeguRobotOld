...
import MeguBot.modules.sql.feds_sql as sql
from MeguBot import (GBAN_LOGS, LOGGER, OWNER_ID, SUDO_USERS, FROG_USERS,
...
from MeguBot.modules.helper_funcs.extraction import (extract_unt_fedban,
                                                          extract_user,
                                                          extract_user_fban)
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if user_id == OWNER_ID:
        message.reply_text("El propietario del  bot no puede ser baneado de una federación!")
        return
