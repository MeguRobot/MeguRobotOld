...
def list_chatbot_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Chats habilitados para Chatbot:</b>\n"
    for chat in chats:
        try:
...
__help__ = f"""
El bot de chat utiliza la API CoffeeHouse y permite que Megu hable y proporciona una experiencia en grupos más interactiva.
*Comandos:*
*Solo administradores:*
 •`/addchat`*:* Habilita el modo Chatbot en el chat.
 •`/rmchat`*:* Desactiva el modo Chatbot en el chat.
 
*Demonios o superior únicamente:*
