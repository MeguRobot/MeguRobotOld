...
Soy una amante a las explosiones y ayudo a los administradores a moderar sus grupos con Explosion![💥]({})
"""
...
*Principales comandos disponibles*:
 ...
 •`/settings`*:*
  • *En privado:* Le enviará la configuración de todos los módulos.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Añade a Megu a tu grupo",
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            ...
            return
        update.effective_message.reply_text(
            "Contácteme en privado para obtener la ayuda.",
            reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton(
                    text="Ayuda",
...
def settings_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            chat = bot.get_chat(chat_id)
            query.message.reply_text(
                "Hola! Hay algunas configuraciones para {}. Continúa y elije qué "
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        try:
            ...
            update.effective_message.reply_text(
                "Le envié un mensaje en privado sobre la información para donar!")
        except Unauthorized:
            update.effective_message.reply_text(
